...
[[nodiscard]] constexpr std::uint32_t encode_m(
    ...
    return (0x01U << 25U) | ((source2 & 0x1FU) << 20U) |
           ((source1 & 0x1FU) << 15U) | ((function3 & 0x7U) << 12U) |
           ((destination & 0x1FU) << 7U) | opcode;
}
...
void test_division_and_remainder(TestContext& context) {
    ...
    execute_case(context, "DIV", false, 4U, negative_seven_and_three[0], negative_seven_and_three[1], 0xFFFF'FFFF'FFFF'FFFEULL);
    execute_case(context, "DIVU", false, 5U, 0xFFFF'FFFF'FFFF'FFFFULL, 2U, 0x7FFF'FFFF'FFFF'FFFFULL);
    execute_case(context, "REM", false, 6U, negative_seven_and_three[0], negative_seven_and_three[1], 0xFFFF'FFFF'FFFF'FFFFULL);
    ...
    execute_case(context, "DIVUW", true, 5U, 0xFFFF'FFFF'FFFF'FFFFULL, 2U, 0x0000'0000'7FFF'FFFFULL);
...
void test_division_edges(TestContext& context) {
    ...
    execute_case(context, "REM 除零", false, 6U, 0x8000'0000'0000'1234ULL, 0U, 0x8000'0000'0000'1234ULL);
    execute_case(context, "REMU 除零", false, 7U, 0xFEDC'BA98'7654'3210ULL, 0U, 0xFEDC'BA98'7654'3210ULL);
    ...
    execute_case(context, "DIVW 溢出", true, 4U, minimum32_box, 0xFFFF'FFFFU, 0xFFFF'FFFF'8000'0000ULL);
...
void test_aliasing_x0_and_reserved_encoding(TestContext& context) {
    ...
    if (result.trap.has_value()) {
        context.expect(result.trap->cause == rvemu::core::ExceptionCause::IllegalInstruction, "保留 M 编码必须报告非法指令");
    }
}
