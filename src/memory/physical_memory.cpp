...
bus::AccessResult PhysicalMemory::validate(
    std::uint64_t offset,
...
std::uint64_t PhysicalMemory::read_unlocked(
    std::uint64_t offset,
    bus::AccessWidth width) const {
...
void PhysicalMemory::write_unlocked(
    std::uint64_t offset,
...
bus::AccessResult PhysicalMemory::read(
    std::uint64_t offset,
    bus::AccessWidth width,
    bus::AccessType type) {
...
bus::AccessResult PhysicalMemory::write(
    std::uint64_t offset,
    bus::AccessWidth width,
    std::uint64_t value,
    bus::AccessType type) {
...
bus::AccessResult PhysicalMemory::compare_exchange(
    std::uint64_t offset,
    bus::AccessWidth width,
